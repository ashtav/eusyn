...
}`}),C,n(c,{onSelect:r.onSelect,config:{label:"Select File",required:!0}},null,8,["onSelect"]),n(o,{code:'<FileHandler :config="{}" @select="onSelect" />'}),V,t("ul",q,[(g(!0),d(x,null,w(p.images,i=>(g(),d("li",null,[t("img",{src:i.data,alt:i.name},null,8,E),t("h5",null,y(i.name),1)]))),256))]),N,n(c,{onSelect:r.onSelect,accept:"audio:mp3,wav,mpeg|video:mp4,avi,mov",config:{label:"Select Audio/Video",required:!0}},null,8,["onSelect"]),n(o,{code:'<FileHandler :config="{}" @select="onSelect" accept="audio:mp3,wav,mpeg|video:mp4,avi,mov" />'})])])])}const Q=S(j,[["render",P],["__scopeId","data-v-b3b8bb82"]]);export{Q as default};
